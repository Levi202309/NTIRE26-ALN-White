...
class my_dataset_eval(Dataset):
    def __init__(self,root_in, root_label, transform =None,fix_sample=100):
        ...
        in_files = sorted(os.listdir(root_in))  # 获取输入图像文件名列表并排序
...
class my_dataset_infer(Dataset):
    def __init__(self,root_in, transform =None,fix_sample=100):
        super(my_dataset_infer,self).__init__()
